...
1. Save a postgres password to your local environment `export POSTGRES_PASSWORD=<some password you decide>`. Alternatively, you can create a `.env` file in the `docker` sub-directory and add the line `POSTGRES_PASSWORD=<some password you decide>` to it.
