...
where (CURRENT_DATE::date - pna.patient_reported::date) >= 300', '2022-02-01 19:00:00.000 -0500', '2022-02-01 19:00:00.000 -0500', 'Lorenzo');
-- WT-1
INSERT INTO dot.configured_tests VALUES(TRUE, 'Muso', '3081f033-e8f4-4f3b-aea8-36f8c5df05dc', 'INCONSISTENT-1', 3, 'Wrong treatment/dosage arising from wrong age of children (WT-1)', '', '', 'baf349c9-c919-40ff-a611-61ddc59c2d52', 'expression_is_true', '', '', 'name: "t_under_24_months_wrong_dosage"| expression: "malaria_act_dosage is not null"| condition: "(patient_age_in_months<24) and (malaria_give_act is not null)"', '2022-02-14 19:00:00.000 -0500', '2022-02-14 19:00:00.000 -0500', 'Lorenzo');
-- NFP-1
INSERT INTO dot.configured_tests VALUES(TRUE, 'Muso', 'c4a3da8f-32f4-4e9b-b135-354de203ca70', 'TREAT-1', 3, 'Test for new family planning method', '', '', '95bd0f60-ab59-48fc-a62e-f256f5f3e6de', 'custom_sql', '', '', 'select
    a.patient_id,
    a.reported,
    ...
    and fp_method_being_used not like ''%condom%''', '2021-12-23 19:00:00.000 -0500', '2021-12-23 19:00:00.000 -0500', 'Lydia');
-- LMP-1
INSERT INTO dot.configured_tests VALUES (TRUE, 'Muso', '3081f033-e8f4-4f3b-aea8-36f8c5df05dc','INCONSISTENT-1',5,'Erroneous LMP Date','10','Put a validation on the application that no LMP should be less than 4 weeks at the time of registration','638ed10b-3a2f-4f18-9ca1-ebf23563fdc0','custom_sql','','','select
        ap.uuid,
        ap.days_since_lmp,
...
order by round(ap.days_since_lmp::float)','2022-02-15 20:00:00.000 -0500','2022-02-15 20:00:00.000 -0500','Rahul');
-- LMP-2
INSERT INTO dot.configured_tests VALUES (TRUE, 'Muso', '3081f033-e8f4-4f3b-aea8-36f8c5df05dc','INCONSISTENT-1',5,'LMP Date at Beginning of Month','10','Use days/weeks since LMP instead of months as this may be much closer to the actual LMP instead of months since LMP','638ed10b-3a2f-4f18-9ca1-ebf23563fdc0','custom_sql','','','select
        ap.uuid,
        ap.days_since_lmp,
